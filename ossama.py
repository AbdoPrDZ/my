...
class Package(tk.Frame): # hadi frame bach ta3 kol wa7d liphoto wla video t9dr tbdl ana drt example nta dir kima 7bit
  ...
  def add_item(self, name, image): # hada bach izid fichi t9dr tmodifi fih kima 7bit
    ...
    tk.Label(frame, text = name).pack(fill = "x") # hada ism elmilaf
...
if __name__ == "__main__":
  ...
  side_menu.add('Home', 'home.png', func = lambda: sliders.show('Home')) # lbutton ta3 home
  side_menu.add('Photos', 'photo1.png', func = lambda: sliders.show('Photos')) # lbutton ta3 photos
  side_menu.add('Videos', 'photo2.png', func = lambda: sliders.show('Videos')) # lbutton ta3 videos
  side_menu.add('Music', 'photo3.png', func = lambda: sliders.show('Music')) # lbutton ta3 music
